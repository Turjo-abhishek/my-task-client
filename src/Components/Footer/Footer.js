...
//         <button type="button" class="inline-block px-6 py-2 border-2 font-medium text-xs leading-tight uppercase rounded-full hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out">
//           Sign up!
//         </button>
//       </p>
//     </div>
...
//     © 2021 Copyright:
//     <a class="" href="https://tailwind-elements.com/">Tailwind Elements</a>
//   </div>
// </footer>
<footer className=" px-4 divide-y bg-gradient-to-tr from-slate-500 to-yellow-100 dark:text-gray-100">
